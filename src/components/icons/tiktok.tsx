...
export const TikTok = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} id="tiktok_icon_dark__Layer_2" viewBox="0 0 352.28 398.67">
    <g id="tiktok_icon_dark__Layer_1-2">
      {/* Glitch Cyan/Biru Muda (Sisi Kiri) */}
      <path 
        fill="#25F4EE" 
      ...
      {/* Glitch Cyan/Biru Muda (Sisi Atas & Lengkungan Dalam) */}
      <path 
        fill="#25F4EE" 
